...
return [
    'modules' => [
        ...
        'SouthPole_AllowMaxQty' => 1,
        'SouthPole_CheckoutCustomization' => 1,
        'SouthPole_CustomCheckout' => 1,
        'SouthPole_PaymentDisable' => 1,
        'SouthPole_ProductDecimalQty' => 1,
        'SouthPole_Roadmap' => 1,
        'SplashLab_CorsRequests' => 1,
        'StripeIntegration_Payments' => 1,
        'Temando_ShippingRemover' => 1,
        'Webkul_AdminActionLog' => 1
    ]
];
